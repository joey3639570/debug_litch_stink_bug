//git clone the repo made by vincentgong7 from: https://github.com/vincentgong7/VG_AlexeyAB_darknet.git
//first, install darknet and replace /src/detector.c by this file
//then run DetectionDemo
    ...
    char *in_folder, char *out_folder)
{
    ...
    printf("folder input=%s and output=%s\n", in_folder, out_folder);
        ...
        //Modified by sky712345678, let it obtain filename in alphabetical order
        struct  dirent ** fileList;
        int numOfFiles;
        numOfFiles = scandir(in_folder, &fileList, NULL, alphasort);
        if(numOfFiles>2){
