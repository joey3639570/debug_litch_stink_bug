...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tab1_left_picture_navigate_button.setFixedWidth(60)
        ...
        self.tab1_right_picture_navigate_button.setFixedWidth(60)
...
if __name__ == "__main__":
    ...
    translator.load('zh-tw_for_DetectionDemo_single')
