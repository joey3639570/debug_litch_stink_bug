...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.imageSourceDescriptionLabel.setGeometry(QRect(40, 40, 341, 21))
        ...
        self.destinationDescriptionLabel.setGeometry(QRect(40, 260, 361, 21))
        ...
        self.xmlSourceLabel.setGeometry(QRect(20, 120, 221, 31))
        ...
        self.xmlSourceDescriptionLabel.setGeometry(QRect(40, 150, 371, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.imageSourceDescriptionLabel.setText(QCoreApplication.translate("MainWindow", u"Click \"Browse\" to select image source directory", None))
        self.destinationLabel.setText(QCoreApplication.translate("MainWindow", u"Destination", None))
        self.destinationDescriptionLabel.setText(QCoreApplication.translate("MainWindow", u"Click \"Browse\" to select image destination directory", None))
        self.destinationBrowseButton.setText(QCoreApplication.translate("MainWindow", u"Browse", None))
        self.xmlSourceLabel.setText(QCoreApplication.translate("MainWindow", u"Annotation source", None))
        self.xmlSourceDescriptionLabel.setText(QCoreApplication.translate("MainWindow", u"Click \"Browse\" to select annotation source directory", None))
